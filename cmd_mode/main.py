"""Точка входа CLI‑приложения News Agent."""

import sys

from Agents import NewsProcessingOrchestrator
from config import Config


def main() -> None:
    """Основная функция запуска пайплайна обработки новостей."""
    print("=== News Agent ===")
    print()
    print("Настройки LLM:")
    ...
    if Config.OPENAI_API_BASE:
        ...
        print("  API Endpoint: По умолчанию (OpenAI)")
    print()
    ...
    orchestrator.process_news(feed_urls=rss_feeds, criteria=Config.SELECTION_CRITERIA)
